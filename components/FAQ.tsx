...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Няма разлика в съдържанието - получаваш абсолютно всичко! Early Bird е специална отстъпка от 40% за първите 53 купувачи. След изчерпване на местата, цената става €24.99.',
  },
  {
